...
@DataJpaTest
public class TestModificarUnCliente {
	@Autowired
	...
	@Test
	public void cuandoAlModificarUnClienteQueExisteRetornaTrue() {
		boolean estado = false;
		Cliente cliente = new Cliente("1-1", "Rolando", "Aburto Olivares", "correo1000@correo.cl", "123456789"); 
	...
	@Test
	public void cuandoAlModificarUnClienteQueNoExisteRetornaFalse() {
		boolean estado = false;
		...
		assertFalse("Retorna True si no existe el cliente", estado);
	}
	
	@SuppressWarnings("unused")
	@Test
	public void cuandoIntentaModificarUnObjetoNullRetornaFalse() {
		boolean estado = false;
	...
	@Test
	public void cuandoIntentaModificarUnObjetoConUnCampoNullRetornaFalse() {
		boolean estado = false;
